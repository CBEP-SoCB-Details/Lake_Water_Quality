...
Not coincidentally, Sebago Lake also has one of the longest and richest records
of water quality monitoring of any lake in the region.
...
the GGPLOT default smoothers miss some of this detail, because they oversmooth.
```{r}
